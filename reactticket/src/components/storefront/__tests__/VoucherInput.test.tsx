...
describe('VoucherInput Component', () => {
  ...
  it('renders correctly', () => {
    vi.spyOn(useVoucherModule, 'useVoucher').mockReturnValue({ applyVoucher: vi.fn(), isLoading: false, error: null } as any);
    render(
  ...
  it('calls applyVoucher on click', async () => {
    ...
    vi.spyOn(useVoucherModule, 'useVoucher').mockReturnValue({ applyVoucher: mockApply, isLoading: false, error: null } as any);
