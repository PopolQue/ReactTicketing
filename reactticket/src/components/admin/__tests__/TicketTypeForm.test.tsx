...
describe('TicketTypeForm Component', () => {
  ...
  it('renders correctly', () => {
    render(<table><tbody><TicketTypeForm newType={mockNewType} setNewType={vi.fn()} addTicketType={vi.fn()} /></tbody></table>);
  ...
  it('calls setNewType when name input changes', () => {
    ...
    render(<table><tbody><TicketTypeForm newType={mockNewType} setNewType={setNewType} addTicketType={vi.fn()} /></tbody></table>);
    fireEvent.change(screen.getByLabelText('New ticket type name'), { target: { value: 'Early Bird' } });
  ...
  it('calls setNewType when capacity changes', () => {
    const setNewType = vi.fn();
    render(<table><tbody><TicketTypeForm newType={mockNewType} setNewType={setNewType} addTicketType={vi.fn()} /></tbody></table>);
    fireEvent.change(screen.getByLabelText('New ticket type capacity'), { target: { value: '50' } });
  ...
  it('calls setNewType when startDate changes', () => {
    const setNewType = vi.fn();
    render(<table><tbody><TicketTypeForm newType={mockNewType} setNewType={setNewType} addTicketType={vi.fn()} /></tbody></table>);
    fireEvent.change(screen.getByLabelText('New ticket type valid from date'), { target: { value: '2026-06-01' } });
  ...
  it('calls setNewType when startTime changes', () => {
    const setNewType = vi.fn();
    render(<table><tbody><TicketTypeForm newType={mockNewType} setNewType={setNewType} addTicketType={vi.fn()} /></tbody></table>);
    fireEvent.change(screen.getByLabelText('New ticket type valid from time'), { target: { value: '10:00' } });
  ...
  it('calls setNewType when endDate changes', () => {
    const setNewType = vi.fn();
    render(<table><tbody><TicketTypeForm newType={mockNewType} setNewType={setNewType} addTicketType={vi.fn()} /></tbody></table>);
    fireEvent.change(screen.getByLabelText('New ticket type valid until date'), { target: { value: '2026-06-30' } });
  ...
  it('calls setNewType when endTime changes', () => {
    const setNewType = vi.fn();
    render(<table><tbody><TicketTypeForm newType={mockNewType} setNewType={setNewType} addTicketType={vi.fn()} /></tbody></table>);
    fireEvent.change(screen.getByLabelText('New ticket type valid until time'), { target: { value: '18:00' } });
  ...
  it('calls addTicketType when button is clicked', () => {
    ...
    render(<table><tbody><TicketTypeForm newType={mockNewType} setNewType={vi.fn()} addTicketType={addTicketType} /></tbody></table>);
