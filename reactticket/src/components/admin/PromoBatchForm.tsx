...
export const PromoBatchForm: React.FC<PromoBatchFormProps> = ({
  ...
  return (
    <div
      ...
      role="region"
      aria-label="Create Promo Code Batch Form"
    >
      <label
        style={{
          display: 'flex',
      ...
      >
        Discount Type
        <select
          value={newBatch.discountType}
          onChange={(e) =>
            setNewBatch({ ...newBatch, discountType: e.target.value as 'percent' | 'free' })
          }
        >
      ...
      {newBatch.discountType === 'percent' && (
        ...
        >
          ...
          <input
            type="number"
            value={newBatch.discountValue}
            onChange={(e) => setNewBatch({ ...newBatch, discountValue: parseInt(e.target.value) })}
          />
        </label>
      )}
      {newBatch.discountType === 'free' && (
        ...
        >
          Applies To
          <select
            value={newBatch.ticketTypeId}
            onChange={(e) => setNewBatch({ ...newBatch, ticketTypeId: e.target.value })}
          >
      ...
      <div style={{ display: 'flex', alignItems: 'flex-end' }}>
        <button
          ...
          aria-label="Generate promo batch"
        >
          Generate Batch
        </button>
      </div>
