...
export default function UpdatePasswordForm({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    <>
      <div style={{ textAlign: 'center', marginBottom: '24px' }}>
        <h2 style={{ margin: '0 0 8px 0' }}>Update Password</h2>
        <p style={{ margin: 0, color: 'var(--text-secondary)' }}>Enter your new password below</p>
      </div>
