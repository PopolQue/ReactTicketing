...
export default function EventHero({ event, images, currentImageIndex, setCurrentImageIndex, customAccentColor }: { event: any, images: string[], currentImageIndex: number, setCurrentImageIndex: any, customAccentColor: string }) {
  return (
    <>
      {images.length > 0 && (
