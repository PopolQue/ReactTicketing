...
export default function CreateEvent() {
  ...
  const { formData, handleChange, handleVenueChange, createEvent, loading, error } =
    useEventForm(activeEntity);
        ...
        >
          <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '16px' }}>
            <div>
              ...
              >
                {t('organizer.createEvent.eventTitle')}
              </label>
              <input
                required
                type="text"
                ...
                placeholder={t('organizer.createEvent.eventTitlePlaceholder')}
              />
            </div>
            <div>
              <label
                style={{ display: 'block', marginBottom: '8px', color: 'var(--text-secondary)' }}
              >
                {t('organizer.createEvent.category')}
              </label>
              <Dropdown
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="input-field"
                placeholder={t('organizer.createEvent.cityPlaceholder')}
              />
            </div>
            <div>
              <label
                style={{ display: 'block', marginBottom: '8px', color: 'var(--text-secondary)' }}
              >
                {t('organizer.createEvent.country')}
              </label>
              <input
                required
                type="text"
                ...
                onChange={handleChange}
                className="input-field"
                placeholder={t('organizer.createEvent.countryPlaceholder')}
              />
            </div>
          </div>
          <div>
            <label
              style={{ display: 'block', marginBottom: '8px', color: 'var(--text-secondary)' }}
            >
              {t('organizer.createEvent.description')}
            </label>
            <textarea
              required
              name="description"
            ...
            >
              ...
              <div>
                <strong style={{ display: 'block', color: 'white' }}>
                  {t('organizer.createEvent.isExternal')}
                </strong>
                <span style={{ fontSize: '0.9rem', color: 'var(--text-secondary)' }}>
                  {t('organizer.createEvent.isExternalDesc')}
                </span>
              </div>
            </label>
            ...
            {formData.is_external && (
              ...
              >
                <label
                  style={{ display: 'block', marginBottom: '8px', color: 'var(--text-secondary)' }}
                >
                  {t('organizer.createEvent.externalLink')}
                </label>
                <input
          ...
          <button
            ...
            style={{ marginTop: '12px', alignSelf: 'flex-start', opacity: loading ? 0.7 : 1 }}
          >
