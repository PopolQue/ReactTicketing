      ...
      >
        ...
        <nav style={{ display: 'flex', flexDirection: 'column', gap: '8px', flex: 1 }}>
          <button
            ...
            className={`btn-nav ${location.pathname === '/venue' ? 'active' : ''}`}
            style={{
              padding: '12px',
              textAlign: 'left',
              borderRadius: '8px',
          ...
          >
            {t('venue_layout_dashboard')}
          </button>
          <button
            onClick={() => navigate('/venue/edit')}
            className={`btn-nav ${location.pathname === '/venue/edit' ? 'active' : ''}`}
            style={{
              padding: '12px',
              textAlign: 'left',
              borderRadius: '8px',
