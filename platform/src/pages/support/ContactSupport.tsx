  ...
  return (
    <div style={{ maxWidth: '600px', margin: '60px auto', padding: '0 20px' }}>
      ...
      <p style={{ color: 'var(--text-secondary)', marginBottom: '32px' }}>
        Having trouble with an event or ticket? Let us know and our team will get back to you as soon as possible.
      </p>
      ...
      <form onSubmit={handleSubmit} className="glass-panel" style={{ padding: '32px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
        ...
        <div>
          <label style={{ display: 'block', marginBottom: '8px', color: 'var(--text-secondary)' }}>Subject</label>
          <input 
            type="text" 
            name="subject" 
