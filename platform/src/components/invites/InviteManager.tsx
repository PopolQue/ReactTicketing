      ...
      {showCreate && !newInviteUrl && (
        ...
        >
          ...
          <input
            required
            type="text"
            placeholder={t('entityNameEGBerghain')}
            className="input-field"
            value={entityName}
          ...
          <input
            type="email"
            placeholder={t('inviteeEmailOptional')}
            className="input-field"
            value={inviteeEmail}
