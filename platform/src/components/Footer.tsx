...
export default function Footer() {
  ...
  return <footer style={{
    ...
    overflow: 'hidden'
      ...
      width: '60vw',
      height: '120px',
      background: 'radial-gradient(ellipse at center, rgba(69,38,38,0.25) 0%, transparent 70%)',
      filter: 'blur(40px)',
      pointerEvents: 'none'
    }} />
      ...
      gap: '48px'
        ...
        <div>
          ...
          margin: '0 0 20px 0',
          maxWidth: '280px'
        }}>{t("theFutureOfEventTicketing")}</p>
        </div>

        {/* Link columns */}
        {footerLinkGroups.map(group => <div key={group.title}>
            <h4 style={{
          margin: '0 0 20px 0',
          fontSize: '0.8rem',
          fontWeight: 700,
          ...
          gap: '12px'
              ...
              {group.links.map(link => <li key={link.to}>
      ...
      gap: '8px'
        ...
        fontSize: '0.85rem'
          ...
          © {currentYear}{t("admitAllRightsReserved")}</span>
        <span style={{
